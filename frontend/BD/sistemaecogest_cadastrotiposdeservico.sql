...
INSERT INTO `cadastrotiposdeservico` VALUES (1,'Realizar Poda e Remoção de plantas'),(3,'Liberação de mudas de árvores para beneficiários'),(4,'Medição e análise da qualidade do ar'),(5,'Implementação de medidas contra erosão do solo'),(6,'Monitoramento de recursos hídricos'),(7,'Conservação e manutenção de áreas verdes');
